import { SkillMatch, LocationAnalysis, AdvancedScore } from '../types';
import { DIMENSION_WEIGHTS, CONFIDENCE_THRESHOLDS } from './constants';
...
export function calculateScore(
  ...
  const visaScores: Record<string, number> = { Low: 5, Unknown: 0, Medium: -10, High: -20 };
